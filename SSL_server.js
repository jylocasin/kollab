...
var conf = require('./SSL_config.js').server;
...
var https_options = {
  ...
  key: fs.readFileSync("./crt/wildcard.upperion.fr_2022-06-08.key"),

  cert: fs.readFileSync("./crt/wildcard.upperion.fr_2022-06-08.crt"),

  ca: [

          //fs.readFileSync('path/to/CA_root.crt'),

          fs.readFileSync('./crt/ca_bundle.crt')
...
console.log('Server running at https://127.0.0.1:' + conf.port + '/');
...
router.get('/:id', function(req, res){
	res.render('index.jade', {
		pageTitle: ('Collaborate - ' + req.params.id)
	});
});
...
function initClient ( client )
{
	...
	getRoom(client, function(room) {
		...
		db.getTheme( room, function(theme) {
			...
			if (theme === null) theme = 'smallcards';
